...
async function parseFile(file) {
        ...
        var fileRes = null;
        var value = await getImagecore(dataSet, bRaw);
        //getImagecore(dataSet, bRaw).then(function(value) {
            ...
            if(image.isRaw == false){
                ...
                for(var zi=0; zi<dataSet.DimSize[2];zi++)
                {
                    ...
                    Object.assign(image0, imagei);
                    fileRes = [origin,image0];
                ...
                console.log('===dataSet.DimSize',dataSet.DimSize);
            }
            return fileRes
        //});
}
...
function getImagecore(dataSet, bRaw) {
    ...
    {
        console.log('===ipp.z,slicelocation===',ipp.z,slicelocation);
        ipp.z = slicelocation;
    }
